...
export const buildMessengerManifest = ({
  ...
  if (!pack) {
    return {
      error:
        "City not supported yet. Start with New York, San Francisco, Berlin, London, Tokyo, Mexico City, Bogota, Warsaw, Barcelona, Sao Paulo, Vienna, Santos, Amsterdam, Paris, Milan, Bangkok, Taipei, or Seoul.",
    };
  }
