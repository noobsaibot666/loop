...
const LoopBuilder: React.FC = () => {
  ...
  const {usage, updateUsage, accountSummary, fetchAccountSummary} =
    useCreditStore();
          ...
          <div className="glass-card form-card loop-builder-shell">
              ...
              {usage && (
                <div className="loops-left">
                  ...
                  <span className="loops-left-line">
                    {hasUnlimitedCredits
                      ? t('credits.admin')
                      : t('credits.freeLeft', {count: usage.free_remaining})}
                  </span>
                </div>
              )}
            </div>
            ...
            <div className="form-body">
              ...
              <div className="form-actions">
                <button
                  className={`primary-button manifest-build-button ${canBuildLoop ? 'ready' : ''}`}
                  onClick={handleGenerate}
                  disabled={isGenerating || !canBuildLoop}
                >
            ...
            {statusMessage && (
              <div className="status-message">{t(statusMessage)}</div>
            )}
