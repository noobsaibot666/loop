...
export const ALLEYCAT_CITY_PRESETS = ALLEYCAT_CITY_GROUPS.flatMap(
  group => group.cities,
);

export const toCitySlug = (value = '') =>
  value.trim().toLowerCase().replace(/\s+/g, '');
export const getCityLabel = (value = '') =>
  ALLEYCAT_CITY_PRESETS.find(city => toCitySlug(city) === toCitySlug(value)) ||
  value;
