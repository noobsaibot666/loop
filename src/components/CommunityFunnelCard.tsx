        ...
        <div className="funnel-content">
          <div className="funnel-text">
            ...
            <p className="funnel-subtitle">
              Get unlimited loop generation, high-res proof uploads, and
              exclusive access to the Hardchain community.
            </p>
          </div>
          <div className="funnel-actions">
            <button
              className="primary-button"
              onClick={() => navigate('/loop#credits')}
            >
              Become a Member
            </button>
            <button
              ...
              onClick={() =>
                window.open('https://discord.gg/hardchain', '_blank')
              }
            >
              Join Discord
            </button>
