...
const AuthModal: React.FC<AuthModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="modal-card auth-modal-card animation-slide-up"
        onClick={event => event.stopPropagation()}
      >
        <div className="auth-modal-header">
          <h2 className="modal-title">
            {isSignup
              ? t('account.auth.signUpTitle')
              : t('account.auth.signInTitle')}
          </h2>
          <p className="modal-subtitle">
            {isSignup
              ? t('account.auth.signUpSubtitle')
        ...
        <form className="modal-form auth-modal-form" onSubmit={handleSubmit}>
          ...
          <div className="form-actions auth-modal-actions">
            ...
            <button
              ...
              disabled={isSubmitLoading || !email || !password}
            >
              {isSubmitLoading
                ? t('account.auth.waiting')
                : isSignup
